...
import com.e.docinfamily17nov.Fragment.FragmentConsultant_log
import com.e.docinfamily17nov.Fragment.FragmentPatient_log
import com.e.docinfamily17nov.R
import com.e.docinfamily17nov.databinding.ActivityLoginSectionBinding


class LoginSectionActivity : AppCompatActivity() {
    lateinit var activitybinding: ActivityLoginSectionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activitybinding = DataBindingUtil.setContentView(this, R.layout.activity_login_section)
        getWindow().setFlags(
    ...
    private fun setupViewPager(viewPager: ViewPager) {
        ...
        adapter.addFrag(FragmentPatient_log(), "As Patient")
        adapter.addFrag(FragmentConsultant_log(), "As Consultant")
