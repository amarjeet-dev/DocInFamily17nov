package com.e.docinfamily17nov.Presenter.basePackage
...
import com.e.docinfamily17nov.Utils.AppUtils.hideKeyboardBackFragment


class DocAppPresenterImpl(
    var ctx: Context,
    careAppView: DocAppView?
) : DocAppPresenter {
    var barberAppView: DocAppView? = null
